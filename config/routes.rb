Rails.application.routes.draw do
  ...
  resources :championships, only: %i[index new create show update] do
    ...
    post :create_tranca_partida_in_key, on: :member, path: "rodadas/:rodada_id/chaves/:group_key/jogos"
    ...
    get :edit_tranca_summula, on: :member, path: "tranca/partidas/:partida_id/editar-sumula"
