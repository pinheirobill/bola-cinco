...
Rails.application.configure do
  ...
  # Serve fingerprinted assets from the app itself. This deployment rewrites all
  # requests to Rails, so static files must be handled here instead of falling
  # through to routing.
  ...
  # Vercel test deployment: keep uploads on the local image filesystem for now.
  # Revisit this before customer-facing prod.
